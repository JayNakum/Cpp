...
std::list<std::string> LexicalAnalyzer::splitTokens(std::ifstream& srcFile)
{
...
void LexicalAnalyzer::initTokens()
{
    ...
    std::ifstream tokensFile("D:\\SSCD\\LexicalAnalyzer\\src\\tokens.sscd");
    if (!tokensFile)
    {
